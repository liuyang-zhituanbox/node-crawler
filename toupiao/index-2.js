...
function getRequestData(aid) {
    ...
    return `xenon=onfRL1TlkZvg1J2fVS5zcy1O2RPc&width=636&wechatid=562459&p_time=1535533951&orther_id=onfRL1TlkZvg1J2fVS5zcy1O2RPc&j_time=142&id=14623&height=687&code=7282&aid=${aid}`;
    let data = {
...
function getHeader(aid) {
    ...
    let data = {
        ...
        Referer: 'http://www.citydating9.top/activity_item1.php?aid=324&id=14623&userid=562459&orther_openid=onfRL1TlkZvg1J2fVS5zcy1O2RPc',
