...
function getRequestData(aid) {
    ...
    return `xenon=onfRL1RzebIYfMGDiyM37LsVKN6c&width=636&wechatid=556849&p_time=1535523903&orther_id=onfRL1RzebIYfMGDiyM37LsVKN6c&j_time=370&id=14623&height=687&code=9479&aid=${aid}`;
    let data = {
...
function getHeader(aid) {
    ...
    let data = {
        ...
        Referer: `http://www.citydating9.top/activity_item1.php?aid=324&id=14623&userid=556849&orther_openid=onfRL1RzebIYfMGDiyM37LsVKN6c`,
